            ...
            <form action="" method="post">
                ...
                <div class="contact-form row">
                    ...
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_STD_NAME" placeholder="Full Name" required />
                    </div>
                    <!-- std_name ends  -->
                    ...
                    <!-- nick name starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text " type="text" name="p_NICK_NAME" placeholder="Nick Name" required />
                    </div>
                    <!-- nick name ends  -->
                    ...
                    <!-- school name starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SCHOOL_NAME" placeholder="School Name" required />
                    </div>
                    <!-- school name ends  -->
                    ...
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SCHOOL_DIS" placeholder="School District Name" required />
                    </div>
                    ...
                    <!-- ssc pass starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SSC_PASS_YEAR" placeholder="SSC Pass Year" required />
                    </div>
                    <!-- ssc pass ends  -->
                    ...
                    <!-- college name starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_COLLAGE_NAME" placeholder="College Name" required />
                    </div>
                    <!-- college name ends  -->
                    ...
                    <!-- hsc pass starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_HSC_PASS_YEAR" placeholder="HSC Pass Year" required />
                    </div>
                    <!-- hsc pass ends  -->
                    ...
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_PRESENT_PROFESSION" placeholder="Present Profession" required />
                    </div>
                    ...
                    <!-- org name starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_WORK_PLACE_NAME" placeholder="Organization Name" required />
                    </div>
                    <!-- org name ends  -->
                    ...
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_WORK_PLACE_ADDRESS" placeholder="Working Address" required />
                    </div>
                    ...
                    <!-- spouse name starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SPOUSE_NAME" placeholder="Spouse Name" required />
                    </div>
                    <!-- spouse name ends  -->
                    ...
                    <!-- spouse job starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SPOUSE_JOB" placeholder="Spourse Working Place" required />
                    </div>
                    <!-- spouse job ends  -->
                    ...
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_SPOUSE_BLOOD" placeholder="Spouse Blood Group" required />
                    </div>
                    ...
                    <div class="form-field col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="baby1 form-inline" id='baby1' style="display: none;">
                                <input type="text" name="p_BABY_NAME" id="name1" class="form-control" placeholder="First Baby Name" />
                                <input type="text" name="p_BABY_AGE1" id="age1" class="form-control" placeholder="First Baby Age" />
                            </div>
                            <div class="baby2 form-inline" id='baby2' style="display: none;">
                                <input type="text" name="p_BABY_NAME2" id="name2" class="form-control" placeholder="Second Baby Name" />
                                <input type="text" name="p_BABY_AGE2" id="age2" class="form-control" placeholder="Second Baby Age" />
                            </div>
                            <div class="baby3 form-inline" id='baby3' style="display: none;">
                                <input type="text" name="p_BABY_NAME3" id="name3" class="form-control" placeholder="Third Baby Name" />
                                <input type="text" name="p_BABY_AGE3" id="age3" class="form-control" placeholder="Third Baby Age" />
                            </div>
                            <div class="baby4 form-inline" id='baby4' style="display: none;">
                                <input type="text" name="p_BABY_NAME4" id="name4" class="form-control" placeholder="Fourth Baby Name" />
                                <input type="text" name="p_BABY_AGE4" id="age4" class="form-control" placeholder="Fourth Baby Age" />
                            </div>
                            <div class="baby5 form-inline" id='baby5' style="display: none;">
                                <input type="text" name="p_BABY_NAME5" id="name5" class="form-control" placeholder="Fifth Baby Name" />
                                <input type="text" name="p_BABY_AGE5" id="age5" class="form-control" placeholder="Fifth Baby Age" />
                            </div>
                    ...
                    <!-- email starts  -->
                    <div class="form-field col-lg-6">
                        <input id="email" class="input-text" type="email" name="p_EMAIL" placeholder="Email Address" required />    
                    </div>
                    <!-- email ends  -->

                    <!-- phone starts  -->
                    <div class="form-field col-lg-6">
                        <input type="tel" name="p_PHONE" placeholder="Mobile Number(01XXXXXXXXX)" pattern="[0-9]{11}" class="input-text" maxlength="12" title="Eleven digits code" required />
                    </div>
                    <!-- phone ends  -->
                    ...
                    <!-- blood group starts  -->
                    <div class="form-field col-lg-6">
                        <input id="name" class="input-text" type="text" name="p_BLOOD_GROUP" placeholder="Blood Group" required />
                    </div>
                    <!-- blood group ends  -->
                    ...
                    <div class="form-field col-lg-6">
                        ...
                        <input type="tel" name="p_EMERGENCY_PHONE" placeholder="Emergency Mobile Number(01XXXXXXXXX)" pattern="[0-9]{11}" class="input-text" maxlength="12" title="Eleven digits code" required />
                    </div>
